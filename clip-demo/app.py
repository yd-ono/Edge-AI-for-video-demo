...
def draw_score_bar(frame, scores, labels):
    ...
    for i, (label, score) in enumerate(zip(labels, scores)):
        ...
        cv2.rectangle(overlay, (10, y), (10 + bar_len, y + bar_height), (50, int(255 * score), int(255 * (1 - score))), -1)
        cv2.putText(overlay, f"{label}: {score:.2f}", (15, y + bar_height - 8), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (255,255,255), 1)
...
@app.get("/health")
def health():
    return {"status": "healthy" if client and tokenizer else "not_ready"}
