        ...
        await consumer.run({
            ...
            eachMessage: async ({ message }) => {
                try {
                    ...
                    // **RegimentA のデータのみ送信**
                    if (data.id.startsWith("regimentB") || data.id.startsWith("enemy")) {
                        console.log('RegimentB: Received from Kafka:', data);
